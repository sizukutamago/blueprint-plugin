...
| プレフィックス | 用途 | 形式 | 採番元 | 例 |
|---------------|------|------|--------|-----|
| P | ペルソナ | P-XXX (3桁) | 要件定義 | P-001, P-002 |
| Epic | エピック | Epic-XXX (3桁) | 要件定義 | Epic-001, Epic-002 |
| US | ユーザーストーリー | US-XXX (3桁) | 要件定義 | US-001, US-042 |
| AC | 受け入れ基準 | AC-XXX-Y (Story連番) | 要件定義 | AC-001-1, AC-001-2 |
