...
> **前提**: `knowledge-structure.md` を参照。v4 の `core/phases/*.md` と `core/output-structure.md` を品質基準として参照。
...
| 2 | `03_architecture/adr.md` | `.knowledge/decisions/*.md` | 集約・フォーマット変換 |
...
| 5 | `05_api_design/integration.md` | 外部 API クライアント, `.knowledge/contracts/external/` | 外部連携仕様集約 |
...
| .knowledge/ なし | Contract なしでも docs/ 生成は可能（トレーサビリティ検証がスキップされる） |
