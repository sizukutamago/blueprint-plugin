...
4. Level 4: 出力ファイル完全性チェック（全 Wave の必須ファイル存在確認）
5. Level 5: 運用準備チェック（IPA準拠 — SLI/SLO定義、テスト完了基準、NFR測定可能性、トレーサビリティ、バックアップ/DR、監視アラート、インシデント対応、データ分類）
6. Gate 判定（P0/P1/P2 カウント）
